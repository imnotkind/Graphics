...
void CGraphics::M_SetupHieraModels(void)
{
	...
	V_BasicPolygons["A"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("A"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["B"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("B"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["C"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("C"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["D"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("D"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["E"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("E"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["F"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("F"), T4Int(255, 0, 255, 255)));
	V_BasicPolygons["G"] =
		shared_ptr<CSinglePolygon>(new CSinglePolygon(p->M_GetPolygon("G"), T4Int(255, 0, 255, 255)));
